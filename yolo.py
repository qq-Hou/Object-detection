...
class YOLO(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"        : 'model_data/best_epoch_weights.pth',   #ep250-loss0.044-val_loss0.023.pth', #best_epoch_weights
    ...
    def generate(self, onnx=False):
        ...
        #---------------------------------------------------#
        self.net    = YoloBody(self.anchors_mask, self.num_classes, self.phi, phii=4)
