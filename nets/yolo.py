...
class YoloBody(nn.Module):
    def __init__(self, anchors_mask, num_classes, phi, pretrained=False, phii=4):
        ...
        self.backbone   = Backbone(transition_channels, block_channels, base_depth, n, phi, pretrained=pretrained)
        ...
        self.sppcspc                = MySPPF(transition_channels * 32, transition_channels * 16)  #MySPPF SPPCSPC
